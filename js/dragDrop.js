...
// Adicione eventos de scroll para permitir o scroll durante o arrastar em dispositivos móveis
item.addEventListener("touchmove", function (event) {
    // Verifique se o elemento está sendo arrastado
    if (event.target.classList.contains("exercicio-n")) {
        // Permite o scroll enquanto arrasta em dispositivos móveis
